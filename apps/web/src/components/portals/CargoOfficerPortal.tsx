...
export function CargoOfficerPortal({ user, onSignOut }: { user: any; onSignOut: () => void }) {
  const [activeTab, setActiveTab] = useState<'loading' | 'unloading' | 'history'>('loading');
  ...
  const isDestinationYard = station === 'MNY'; // Moniya Yard is Destination Unloading
  ...
  const handleLogWagonLoading = (e: React.FormEvent) => {
    ...
    // Reset seal number for next wagon
    setLoadingForm({
      ...loadingForm,
  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-900 relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* TAB BUTTONS */}
        <div className="flex gap-2 bg-white p-2 rounded-2xl border border-slate-200 shadow-sm font-sans">
          <button
          ...
          >
            Origin Siding Loading & Sealing Desk
          </button>
          ...
          >
            Destination Yard Unloading & Seal Audit
          </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 font-sans">
            ...
            <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
              <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                ...
                <span className="text-xs font-mono font-bold text-blue-700 font-mono">
        ...
        {/* ─── TAB 3: SHIFT LEDGER & PRINTABLE SHIFT TALLY REPORT ─── */}
        {activeTab === 'history' && (
